...
{
  return (
    <section className='bg-insove-blue bg-[url("/images/pattern.svg")] bg-contain bg-left bg-no-repeat'>
      <div className="container text-white py-24 grid gap-10 grid-cols-2 items-center">
